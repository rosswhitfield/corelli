...
GetDetOffsetsMultiPeaks(
        ...
        OutputWorkspace = 'offset',
        MaskWorkspace='mask')
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Si_20492-9_sum4_L1_20.03.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Si_20492-9_sum4_mask_lt_3_L1_20.03.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
...
GetDetOffsetsMultiPeaks(
        ...
        MaxChiSq=MaxChiSq)
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Si_20492-9_sum4_MaxChiSq_'+str(MaxChiSq)+'.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Si_20492-9_sum4_mask_lt_3_MaxChiSq_'+str(MaxChiSq)+'.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
...
GetDetOffsetsMultiPeaks(
        ...
        MaskWorkspace='mask',
        MaxChiSq=2)
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Si_20492-9_sum4_L1_20.03_MaxChiSq_2.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Si_20492-9_sum4_mask_lt_3_L1_20.03_MaxChiSq_2.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
