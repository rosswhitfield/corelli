...
LoadInstrument(Workspace="rawLaB6",Filename="/SNS/users/rwp/CORELLI_Definition_91.07cm.xml",RewriteSpectraMap=False)
...
LoadInstrument(Workspace="rawLaB62",Filename="/SNS/users/rwp/CORELLI_Definition_91.07cm.xml",RewriteSpectraMap=False)
...
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_LaB6_19286_19287_sum4.cal',
...
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_LaB6_19286_19287_sum4_mask_lt_3.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
