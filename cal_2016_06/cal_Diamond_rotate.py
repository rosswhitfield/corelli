...
for run in range(20482,20490):
        ...
        GetDetOffsetsMultiPeaks(
                ...
                MaskWorkspace='mask')
        SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Diamond_'+str(run)+'_sum4.cal',
        ...
        SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Diamond_'+str(run)+'_sum4_mask_lt_3.cal',
                    OffsetsWorkspace="offset",
                    MaskWorkspace='mask')
...
GetDetOffsetsMultiPeaks(
        ...
        OutputWorkspace = 'offset',
        MaskWorkspace='mask')
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Diamond_20482-9_sum4.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Diamond_20482-9_sum4_mask_lt_3.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
...
for maxchisq in [0.5, 1, 2, 3, 5, 10, 20, 30, 50]:
	GetDetOffsetsMultiPeaks(
		...
		MaskWorkspace='mask',
		MaxChiSq=maxchisq)
	SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Diamond_20482-9_sum4_MaxChiSq'+str(maxchisq)+'.cal',
                    OffsetsWorkspace="offset",
                    MaskWorkspace='mask')
	maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
	MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
	SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_Diamond_20482-9_sum4_mask_lt_3_MaxChiSq'+str(maxchisq)+'.cal',
                    OffsetsWorkspace="offset",
                    MaskWorkspace='mask')
