...
for run in range(20501,20509):
        ...
        LoadInstrument(Workspace="rawC60",Filename="/SNS/users/rwp/CORELLI_Definition_91.07cm.xml",RewriteSpectraMap=False)
...
for run in range(20502,20509):
        ...
        LoadInstrument(Workspace="rawC60_2",Filename="/SNS/users/rwp/CORELLI_Definition_91.07cm.xml",RewriteSpectraMap=False)
...
GetDetOffsetsMultiPeaks(
        ...
        MaskWorkspace='mask')
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_C60_20501-8_sum4_L1_20.03.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_C60_20501-8_sum4_mask_lt_3_L1_20.03.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
...
GetDetOffsetsMultiPeaks(
        ...
        MaxChiSq=5)
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_C60_20501-8_sum4_L1_20.03_MaxChiSq_5.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_06/cal_C60_20501-8_sum4_mask_lt_3_L1_20.03_MaxChiSq_5.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
