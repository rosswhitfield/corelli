...
for r in runs:
    ...
    ConvertToMD(InputWorkspace=data,OutputWorkspace='md3',QDimensions='Q3D',dEAnalysisMode='Elastic',
                QConversionScales='Q in A^-1',LorentzCorrection='0', MinValues='-15.1,-25.1,-15.1',MaxValues='15.1,25.1,15.1')
    FindPeaksMD(InputWorkspace='md3',DensityThresholdFactor=50000, OutputWorkspace='peaks3',AppendPeaks=True)
