...
for run in range(47327,47335):
    ...
    GetDetOffsetsMultiPeaks(
        ...
        MaskWorkspace='mask')
    SaveCalFile(Filename='cal_Si_tube_'+str(run)+'_sum16.cal',
    ...
    SaveCalFile(Filename='cal_Si_tube_'+str(run)+'_sum16_mask_lt_3.cal',
                OffsetsWorkspace="offset",
                MaskWorkspace='mask')
...
GetDetOffsetsMultiPeaks(
    ...
    OutputWorkspace = 'offset',
    MaskWorkspace='mask')
SaveCalFile(Filename='cal_Si_tube_47327-47334_sum16.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='cal_Si_tube_47327-47334_sum16_mask_lt_3.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
