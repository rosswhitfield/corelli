...
SaveCalFile(Filename='cal_C60_2_'+runs+'_sum16_short.cal',
...
SaveDiffCal(CalibrationWorkspace="cal",
            MaskWorkspace="Mask",
            Filename='cal_C60_2_'+runs+'_sum16_mask_lt_2_short.h5')

maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('Mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='cal_C60_2_'+runs+'_sum16_mask_lt_3_short.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='Mask')
ConvertDiffCal(OffsetsWorkspace="offset",
               OutputWorkspace="cal")
SaveDiffCal(CalibrationWorkspace="cal",
            MaskWorkspace="Mask",
            Filename='cal_C60_2_'+runs+'_sum16_mask_lt_3_short.h5')
...
SaveCalFile(Filename='cal_C60_2_'+runs+'_TubeCal_sum16_short.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='Mask')
ConvertDiffCal(OffsetsWorkspace="offset",
               OutputWorkspace="cal")
SaveDiffCal(CalibrationWorkspace="cal",
            MaskWorkspace="Mask",
            Filename='cal_C60_2_'+runs+'_TubeCal_sum16_short.h5')

maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <2)
MaskDetectors('Mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='cal_C60_2_'+runs+'_TubeCal_sum16_mask_lt_2_short.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='Mask')
ConvertDiffCal(OffsetsWorkspace="offset",
               OutputWorkspace="cal")
SaveDiffCal(CalibrationWorkspace="cal",
            MaskWorkspace="Mask",
            Filename='cal_C60_2_'+runs+'_TubeCal_sum16_mask_lt_2_short.h5')

maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('Mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='cal_C60_2_'+runs+'_TubeCal_sum16_mask_lt_3_short.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='Mask')
ConvertDiffCal(OffsetsWorkspace="offset",
               OutputWorkspace="cal")
SaveDiffCal(CalibrationWorkspace="cal",
            MaskWorkspace="Mask",
            Filename='cal_C60_2_'+runs+'_TubeCal_sum16_mask_lt_3_short.h5')
