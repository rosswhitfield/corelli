...
CopyInstrumentParameters('AlignCombined', 'data')
...
SaveCalFile(Filename='cal_C60_2_'+runs+'_sum16_step2.cal',
...
SaveDiffCal(CalibrationWorkspace="cal",
            MaskWorkspace="Mask",
            Filename='cal_C60_2_'+runs+'_sum16_step2_mask_lt_3.h5')
