...
cal_aligned4 = np.loadtxt('difc_aligned4.txt')
...
with h5py.File('cal5.h5', 'r') as f:
    cal5= f['calibration/difc'].value
...
plt.plot(cal5/cal_aligned4,label='cal5')
plt.legend()
plt.show()
