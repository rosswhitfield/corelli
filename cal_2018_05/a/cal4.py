...
LoadIsawDetCal('rawSi','/SNS/users/rwp/corelli/cal_2018_05/a/Aligned3.nxs.detcal')
...
SaveDiffCal(CalibrationWorkspace='combined_cal', MaskWorkspace='combined_mask', Filename='/SNS/users/rwp/corelli/cal_2018_05/a/cal4.h5')
