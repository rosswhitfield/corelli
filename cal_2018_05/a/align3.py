...
LoadDiffCal(Filename='/SNS/users/rwp/corelli/cal_2018_05/a/cal3.h5',InstrumentName='CORELLI',WorkspaceName='cal')
...
SaveNexus('corelli','/SNS/users/rwp/corelli/cal_2018_05/a/Aligned3.nxs')
