...
y=0.02
MoveInstrumentComponent(Workspace='rawC60',ComponentName='A row',Y=y,RelativePosition=False)
MoveInstrumentComponent(Workspace='rawC60',ComponentName='B row',Y=y,RelativePosition=False)
MoveInstrumentComponent(Workspace='rawC60',ComponentName='C row',Y=y,RelativePosition=False)
