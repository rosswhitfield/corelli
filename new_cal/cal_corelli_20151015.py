...
MaskFile = MaskName+'.xml'
LoadMask(Instrument='CORELLI', InputFile=inputdir+MaskFile, OutputWorkspace=MaskName)
...
MaskName='Run14324_Mask'
#SumNeighbours(InputWorkspace = str(siliconD), OutputWorkspace=str(siliconD), SumX=2, SumY=2)
print '[DB] Inputworkspace = %s, maskWorkspace = %s' % (str(siliconD), str(wsmask))
...
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/new_cal/cal_run14324.dat',
