...
componentName = mtd['COR_4597'].getInstrument().getSource().getFullName()
MoveInstrumentComponent('COR_4597', componentName, Z=-20.5204, RelativePosition=False)
...
SaveCalFile(Filename="/SNS/users/rwp/corelli/new_cal/c60_sn_source.cal",OffsetsWorkspace="COR_4597_offset",MaskWorkspace="COR_4597_mask")
