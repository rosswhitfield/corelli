ytfrom mantid.simpleapi import *
...
LoadInstrument(Workspace="COR_4597",Filename="/SNS/users/rwp/corelli/new_cal/CORELLI_Definition_c60.xml",RewriteSpectraMap=False)
...
# Calculate offsets
SumNeighbours(InputWorkspace="COR_4597_d", OutputWorkspace="COR_4597_d", SumX=1, SumY=8)
...
SaveCalFile(Filename="/SNS/users/rwp/corelli/new_cal/c60_sn8_step2.cal",OffsetsWorkspace="COR_4597_offset",MaskWorkspace="COR_4597_mask")
