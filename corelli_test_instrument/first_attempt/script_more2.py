...
for n in xrange(size):
    a=f.read(8)
    (tof,pid) = unpack('ii',a)
    if (pid > 4960 and pid < 5024) or (pid > 4704 and pid < 4768) or (pid > 4448 and pid < 4512) or (pid > 4192 and pid < 4256) or (pid > 3936 and pid < 4000) or (pid > 3680 and pid < 3744) or (pid > 3424 and pid < 3488) or (pid > 3168 and pid < 3232):
        count += 1
        #print count, pid
        tof = tof/10.-52.
...
np.save('out_373_8_middle_64',out)
...
np.save('results_373_8_middle_64',results)
results /=64
