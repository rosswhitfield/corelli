...
fig.suptitle('DAS_374 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_374_4960-5024.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_374_4960-5024_2.png')


results = np.load('results_374_4960-5024.npy')
fig, ax = plt.subplots(figsize=(11,8.5))
...
fig.savefig('cross_374_4960-5024.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_374_4960-5024_2.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_374_4960-5024_r.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_374_4960-5024_r2.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_374_4960-5024_r.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_374_4960-5024_r2.png')
