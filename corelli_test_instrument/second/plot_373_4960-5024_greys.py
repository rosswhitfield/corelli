...
p = ax.pcolormesh(X, Y, out, cmap='Greys')
...
fig, ax = plt.subplots(figsize=(11,8.5))
p = ax.pcolormesh(X, Y, out, vmin=0, vmax=math.pow(out.max(),0.5), cmap='Greys')
cb = fig.colorbar(p, ax=ax)
fig.suptitle('DAS_373 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
...
fig, ax = plt.subplots(figsize=(11,8.5))
p = ax.pcolormesh(X, Y, results, vmin=0, cmap='Greys')
cb = fig.colorbar(p, ax=ax)
fig.suptitle('DAS_373 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
...
fig, ax = plt.subplots(figsize=(11,8.5))
p = ax.pcolormesh(X, Y, results, vmin=0, vmax=math.pow(results.max(),0.33333), cmap='Greys')
cb = fig.colorbar(p, ax=ax)
fig.suptitle('DAS_373 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
...
fig, ax = plt.subplots(figsize=(11,8.5))
p = ax.pcolormesh(X, Y, out[:,1000:2500], vmin=0, cmap='Greys')
cb = fig.colorbar(p, ax=ax)
fig.suptitle('DAS_373 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
...
fig, ax = plt.subplots(figsize=(11,8.5))
p = ax.pcolormesh(X, Y, out[:,1000:2500], vmin=0, vmax=math.pow(out.max(),0.5), cmap='Greys')
cb = fig.colorbar(p, ax=ax)
fig.suptitle('DAS_373 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
...
fig, ax = plt.subplots(figsize=(11,8.5))
p = ax.pcolormesh(X, Y, results[:,1000:2500], vmin=0, cmap='Greys')
cb = fig.colorbar(p, ax=ax)
fig.suptitle('DAS_373 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
...
fig, ax = plt.subplots(figsize=(11,8.5))
p = ax.pcolormesh(X, Y, results[:,1000:2500], vmin=0, vmax=math.pow(results.max(),0.33333), cmap='Greys')
cb = fig.colorbar(p, ax=ax)
fig.suptitle('DAS_373 pixelID:4960-5024')
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
