...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_374_499_2.png')


results = np.load('results_374_499.npy')
fig, ax = plt.subplots(figsize=(11,8.5))
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_374_499_2.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_374_499_r.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_374_499_r2.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_374_499_r.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_374_499_r2.png')
