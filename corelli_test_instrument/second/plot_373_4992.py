...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_373_4992_2.png')


results = np.load('results_373_4992.npy')
fig, ax = plt.subplots(figsize=(11,8.5))
...
fig.savefig('cross_373_4992.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_373_4992_2.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_373_4992_r.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('chopper offset (uS)')
fig.savefig('chopper_373_4992_r2.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_373_4992_r.png')
...
ax.set_xlabel('total time of flight (uS)')
ax.set_ylabel('incident flight time (uS)')
fig.savefig('cross_373_4992_r2.png')
