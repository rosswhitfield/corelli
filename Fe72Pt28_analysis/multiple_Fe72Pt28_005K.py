...
#data3=mtd['data3']
SetGoniometer(data3,Axis0="BL9:SampleRotation:phi,0,1,0,1")
LoadIsawUB(InputWorkspace=van,Filename=outputdir+"Fe72Pt28UB_005K.mat")
...
SaveMD(vanHisto,outputdir+"VanHisto0050K.nxs")
SaveMD(dataHisto,outputdir+"DataHisto_005K.nxs")         
norm=dataHisto/vanHisto
SaveMD(norm,outputdir+"NormlizedHisto_005K.nxs")         
