outputdir="/SNS/CORELLI/IPTS-12008/shared/Fe72Pt28_analysis/"
...
#data=Load("CORELLI_2096:2135")
#data=Load("CORELLI_2136:2167")
...
SaveMD(vanHisto,outputdir+"VanHisto_100K.nxs")
SaveMD(dataHisto,outputdir+"DataHisto_100K.nxs")         
norm=dataHisto/vanHisto
SaveMD(norm,outputdir+"NormlizedHisto_100K.nxs")         
