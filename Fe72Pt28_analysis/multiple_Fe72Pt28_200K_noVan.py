...
LoadIsawUB(InputWorkspace=data3,Filename=outputdir+"Fe72Pt28UB_100K.mat")
...
SaveMD(dataHisto,outputdir+"DataHisto_200K_cc.nxs")
vanHisto=LoadMD(outputdir+"VanHisto_200K.nxs")
norm=dataHisto/vanHisto
SaveMD(norm,outputdir+"NormlizedHisto_200K_cc.nxs")         
