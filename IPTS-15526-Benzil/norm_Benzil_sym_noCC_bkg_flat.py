...
SaveMD(Inputworkspace='dataMD',Filename=outputdir+'benzil_100K_data_sym_All_noCC_flat.nxs')
SaveMD(Inputworkspace='normMD',Filename=outputdir+'benzil_100K_norm_sym_All_noCC_flat.nxs')
SaveMD(Inputworkspace='normData',Filename=outputdir+'benzil_100K_normData_sym_All_noCC_flat.nxs')
SaveMD(Inputworkspace='bkgMD',Filename=outputdir+'benzil_100K_bkg_sym_All_noCC_flat.nxs')
SaveMD(Inputworkspace='bkg_normMD',Filename=outputdir+'benzil_100K_bkg_norm_sym_All_noCC_flat.nxs')
SaveMD(Inputworkspace='bkgNormData',Filename=outputdir+'benzil_100K_bkgNormData_sym_All_noCC_flat.nxs')
SaveMD(Inputworkspace='bkg_subtract',Filename=outputdir+'benzil_100K_bkg_subtract_sym_All_noCC_flat.nxs')
