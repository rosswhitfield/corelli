...
SaveMD(Inputworkspace='dataMD',Filename=outputdir+'benzil_300K_data_sym_All_noCC.nxs')
SaveMD(Inputworkspace='normMD',Filename=outputdir+'benzil_300K_norm_sym_All_noCC.nxs')
SaveMD(Inputworkspace='normData',Filename=outputdir+'benzil_300K_normData_sym_All_noCC.nxs')
SaveMD(Inputworkspace='bkgMD',Filename=outputdir+'benzil_300K_bkg_sym_All_noCC.nxs')
SaveMD(Inputworkspace='bkg_normMD',Filename=outputdir+'benzil_300K_bkg_norm_sym_All_noCC.nxs')
SaveMD(Inputworkspace='bkgNormData',Filename=outputdir+'benzil_300K_bkgNormData_sym_All_noCC.nxs')
SaveMD(Inputworkspace='bkg_subtract',Filename=outputdir+'benzil_300K_bkg_subtract_sym_All_noCC.nxs')
