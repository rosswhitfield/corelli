...
fig.suptitle('Benzil symmetrized data using Mantid', fontsize=18)
...
plt.savefig("benzil_100K_300K.png",bbox_inches='tight')
...
fig, axes = plt.subplots(nrows=2, ncols=3, figsize=(14, 9))
fig.suptitle('Benzil 300K, HK0 plane, 180° rotation (5° steps)\nSpace Group 152 (P-3m1) symmetry operations using Mantid', fontsize=18)
...
plt.savefig("benzil_300K_sym.png",bbox_inches='tight')
