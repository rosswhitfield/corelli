...
bkg_subtract = normData-bkgNormData*0.8
...
SaveMD(Inputworkspace='bkgMD',Filename=outputdir+'benzil_100K_bkg_sym_All_noCC.nxs')
SaveMD(Inputworkspace='bkg_normMD',Filename=outputdir+'benzil_100K_bkg_norm_sym_All_noCC.nxs')
SaveMD(Inputworkspace='bkgNormData',Filename=outputdir+'benzil_100K_bkgNormData_sym_All_noCC.nxs')
SaveMD(Inputworkspace='bkg_subtract',Filename=outputdir+'benzil_100K_bkg_subtract_sym_All_noCC.nxs')
