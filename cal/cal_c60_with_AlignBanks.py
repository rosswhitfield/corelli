...
#LoadNexus(Filename='/SNS/users/rwp/COR_4597_offset_mask_cal2.nxs',OutputWorkspace='cal_align_banks')
LoadIDFFromNexus(Workspace='COR_4597',Filename='/SNS/users/rwp/COR_4597_offset_mask_cal2.nxs',InstrumentParentPath='/mantid_workspace_1')
ClearMaskFlag(Workspace='COR_4597')
...
SaveCalFile(Filename="/SNS/users/rwp/cal/c60_with_AlignBanks.cal",OffsetsWorkspace="COR_4597_offset")
#MaskDetectors(Workspace='COR_4597_offset', MaskedWorkspace='COR_4597_mask')
#SaveNexus(InputWorkspace='COR_4597_offset', Filename='/SNS/users/rwp/cal/COR_4597_offset.nxs')
