...
SetInstrumentParameter(Workspace="COR_4597",ParameterName="t0_formula",Value="86.0*incidentEnergy^(-0.098)")
...
SaveCalFile(Filename="/SNS/users/rwp/cal/c60_t0.cal",OffsetsWorkspace="COR_4597_offset")
MaskDetectors(Workspace='COR_4597_offset', MaskedWorkspace='COR_4597_mask')
SaveNexus(InputWorkspace='COR_4597_offset', Filename='/SNS/users/rwp/cal/COR_4597_offset_t0.nxs')
SaveMask(InputWorkspace="COR_4597_mask",OutputFile="/SNS/users/rwp/cal/COR_4597_mask_t0.mask")
# Check
