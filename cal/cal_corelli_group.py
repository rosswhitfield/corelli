...
GroupDetectors(InputWorkspace='COR_525', OutputWorkspace='COR_525',MapFile="/SNS/users/rwp/cal/groups_16.xml")
...
SaveCalFile(Filename="/SNS/users/rwp/525_cal_group.cal",OffsetsWorkspace="COR_525_offset")
# Check
