...
LoadEventNexus(Filename='/SNS/CORELLI/IPTS-12008/nexus/CORELLI_550.nxs.h5', OutputWorkspace='COR_550')
ChangeBinOffset(InputWorkspace='COR_550', OutputWorkspace='COR_550', Offset='500', IndexMin='237568', IndexMax='249855')
ConvertUnits(InputWorkspace='COR_550', OutputWorkspace='COR_550_d', Target='dSpacing')
Rebin(InputWorkspace='COR_550_d', OutputWorkspace='COR_550_d', Params='1, -0.004, 6')

# Generate fit window workspace
sourcews = mtd["COR_550"]
...
GetDetOffsetsMultiPeaks(
        InputWorkspace = "COR_550_d",
        DReference = FinalDReference,
	FitwindowTableWorkspace=fitwinws,
        PeakFunction = "Gaussian",
        BackgroundType = "Linear",
        HighBackground = True,
        OutputWorkspace = "COR_550_offset")
	
# Check
AlignDetectors(InputWorkspace='COR_550', OutputWorkspace='COR_550_Aligned', OffsetsWorkspace='COR_550_offset')
Rebin(InputWorkspace='COR_550_Aligned', OutputWorkspace='COR_550_Aligned', Params='1, -0.004, 6')
