...
offset=LoadNexus(Filename='/SNS/users/rwp/COR_525_offset_fixed.nxs', OutputWorkspace='offset')
off=offset.extractY().flatten()

c=LoadEmptyInstrument(OutputWorkspace='cor',Filename='/SNS/users/rwp/CORELLI_Definition.xml')
LoadInstrument(Workspace='cor',Filename='/SNS/users/rwp/CORELLI_Definition_offset_fix.xml',RewriteSpectraMap=0)
