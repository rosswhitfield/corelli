...
GroupDetectors(InputWorkspace='COR_4597', OutputWorkspace='COR_4597',MapFile="/SNS/users/rwp/cal/groups_4.xml")
...
SaveCalFile(Filename="/SNS/users/rwp/cal/c60_5g.cal",OffsetsWorkspace="COR_4597_offset")
# Check
