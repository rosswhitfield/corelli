...
#mesh scan at 300K, 70 mins/angle, part1
runs=range(29782,29806)

#mesh scan at 300K, 70 mins/angle, part2
runs=range(29806,29818)
...
SaveMD(Inputworkspace='dataMD_all',Filename=outputdir+'benzil_300K_data_sym_CC.nxs')
SaveMD(Inputworkspace='normMD_all',Filename=outputdir+'benzil_300K_norm_sym_CC.nxs')
SaveMD(Inputworkspace='normdata_All',Filename=outputdir+'benzil_300K_normData_sym_CC.nxs')
