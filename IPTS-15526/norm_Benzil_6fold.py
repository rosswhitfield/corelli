...
LoadIsawUB(InputWorkspace='ub', Filename='/SNS/CORELLI/IPTS-15526/shared/Benzil_100K_UB.mat')
...
for r in runs:
        ...
        for ub in ub_list:
            ...
            md=ConvertToMD(InputWorkspace=dataR,QDimensions='Q3D',dEAnalysisMode='Elastic', Q3DFrames='HKL',
                       QConversionScales='HKL',LorentzCorrection='0',Uproj='1,1,0',Vproj='1,-1,0',Wproj='0,0,1',MinValues='-10.1,-10.1,-3.1',MaxValues='10.1,10.1,3.1')
...
SaveMD(Inputworkspace=dataMD,Filename='/SNS/users/rwp/benzil/benzil_100K_data_6.nxs')
SaveMD(Inputworkspace=normMD,Filename='/SNS/users/rwp/benzil/benzil_100K_norm_6.nxs')
SaveMD(Inputworkspace=normData_100K,Filename='/SNS/users/rwp/benzil/benzil_100K_normData_6.nxs')