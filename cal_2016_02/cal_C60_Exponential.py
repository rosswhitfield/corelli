...
GetDetOffsetsMultiPeaks(
        ...
        MaskWorkspace='mask')
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_C60_20501-8_sum4_E.cal',
...
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_C60_20501-8_sum4_mask_lt_3_E.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
