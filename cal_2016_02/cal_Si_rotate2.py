...
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_Si_20492-9_sum4_MinimumPeakHeight_'+str(MinimumPeakHeight)+'.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_Si_20492-9_sum4_mask_lt_3_MinimumPeakHeight_'+str(MinimumPeakHeight)+'.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
...
GetDetOffsetsMultiPeaks(
        ...
        MaskWorkspace='mask',
        Minimizer=minimizer)
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_Si_20492-9_sum4_'+minimizer+'.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_Si_20492-9_sum4_mask_lt_3_'+minimizer+'.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
...
GetDetOffsetsMultiPeaks(
        ...
        MaskWorkspace='mask',
        CostFunction='Rwp')
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_Si_20492-9_sum4_rwp.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
maskNumberPeaksFitted = np.where(mtd['NumberPeaksFitted'].extractY() <3)
MaskDetectors('mask',DetectorList=maskNumberPeaksFitted[0])
