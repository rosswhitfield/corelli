...
LoadInstrument(Workspace="rawC60",Filename="/SNS/users/rwp/corelli/cal_2016_02/newIDF/CORELLI_Definition_cal2.xml",RewriteSpectraMap=False)
...
for run in range(20502,20509):
        ...
        LoadInstrument(Workspace="rawC60_2",Filename="/SNS/users/rwp/corelli/cal_2016_02/newIDF/CORELLI_Definition_cal2.xml",RewriteSpectraMap=False)
...
GetDetOffsetsMultiPeaks(
        ...
        MaskWorkspace='mask')
# Save calibration
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_C60_20501-8_sum4_cal2.cal',
...
SaveCalFile(Filename='/SNS/users/rwp/corelli/cal_2016_02/cal_C60_20501-8_sum4_mask_lt_3_cal2.cal',
            OffsetsWorkspace="offset",
            MaskWorkspace='mask')
