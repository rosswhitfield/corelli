...
SaveMD(Inputworkspace='dataMD',Filename=outputdir+'data_CC_wbkg_'+outputname+'.nxs')
SaveMD(Inputworkspace='normMD',Filename=outputdir+'V_CC_wbkg_'+outputname+'.nxs')
SaveMD(Inputworkspace='normData',Filename=outputdir+'norm_CC_wbkg_'+outputname+'.nxs')
...
#SaveMD(Inputworkspace='normMD',Filename=outputdir+'norm_sym_CC_nobkg_'+outputname+'.nxs')
#SaveMD(Inputworkspace='normData_sym',Filename=outputdir+'norm_sym_All_CC_nobkg_'+outputname+'.nxs')
