...
SaveMD(Inputworkspace='dataMD',Filename=outputdir+'data_CC_wbkg_'+outputname+'3.nxs')
SaveMD(Inputworkspace='normMD',Filename=outputdir+'V_CC_wbkg_'+outputname+'3.nxs')
SaveMD(Inputworkspace='normData',Filename=outputdir+'norm_CC_wbkg_'+outputname+'3.nxs')
