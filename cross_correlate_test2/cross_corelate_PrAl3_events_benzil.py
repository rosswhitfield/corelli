...
ws=LoadEventNexus(Filename=r'/SNS/CORELLI/IPTS-15526/nexus/'+filename+'.nxs.h5',OutputWorkspace=filename,FilterByTofMin='1000',FilterByTofMax='16000')
...
np.save(filename+'_results_events_b1_bank'+str(bank),results)
