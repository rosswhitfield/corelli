...
#T=680 mK, H=0.8 Tesla
runs =  range(40900,40937,1)

#T=680 mK, H=1.0 Tesla
runs =  range(40938,40946,1)+range(40947,40976,1)

#T=680 mK, H=1.2 Tesla
runs =  range(40977,41014,1)

#T=680 mK, quick check at  H=0 Tesla
runs =  range(41015,41034,1)

#T=680 mK, quick check at  H=0.1 Tesla
runs =  range(41035,41072,1)

#T=680 mK, quick check at  H=0.3 Tesla
runs =  range(41073,41110,1)

#T=680 mK, quick check at  H=0.5 Tesla
runs =  range(41111,41148,1)

#T=680 mK, quick check at  H=1.5 Tesla
runs =  range(41111,41148,1)
...
SaveMD('normData',Filename=outputdir+'DTO_normdata_48sym_680mK_H0.5T_2nd.nxs')
