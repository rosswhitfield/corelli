...
SaveDiffCal('cal',MaskWorkspace='cal_mask', Filename='/SNS/users/rwp/corelli/cal_2018_10/cal_1.h5')

#LoadDiffCal(Filename='/SNS/users/rwp/corelli/cal_2018_10/cal_1.h5',InstrumentName='CORELLI',WorkspaceName='cal_1')
