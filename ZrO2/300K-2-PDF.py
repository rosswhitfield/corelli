...
ConvertMultipleRunsToSingleCrystalMD(Filename='CORELLI_7789:7827',
                                     SetGoniometer=True,
...
SaveIsawUB('peaks', outDir+'ZrO2_300K-2.mat')

SingleCrystalDiffuseReduction(Filename='CORELLI_7789:7827',
                              SolidAngle=outDir+'IPTS-12310/SA.nxs',
                              Flux=outDir+'IPTS-12310/Flux.nxs',
                              OutputWorkspace='output',
                              SetGoniometer=True,
                              Axis0="BL9:Mot:Sample:Axis1,0,1,0,1",
                              UBMatrix=outDir+'ZrO2_300K-2.mat',
...
SaveMD('sym', outDir+'ZrO2_300K-2_sym.nxs')
