...
ConvertMultipleRunsToSingleCrystalMD(Filename='CORELLI_7710:7749',
                                     SetGoniometer=True,
...
SaveIsawUB('peaks', outDir+'ZrO2_6K.mat')

SingleCrystalDiffuseReduction(Filename='CORELLI_7710:7749',
                              SolidAngle=outDir+'IPTS-12310/SA.nxs',
                              Flux=outDir+'IPTS-12310/Flux.nxs',
                              OutputWorkspace='output',
                              SetGoniometer=True,
                              Axis0="BL9:Mot:Sample:Axis1,0,1,0,1",
                              UBMatrix=outDir+'ZrO2_6K.mat',
...
SaveMD('sym', outDir+'ZrO2_6K_sym.nxs')
