...
ws=LoadEventNexus(Filename=r'/SNS/CORELLI/shared/SNS/CORELLI/IPTS-12008/nexus/'+filename+'.nxs.h5',OutputWorkspace=filename,BankName='bank42',SingleBankPixelsOnly='0')
LoadInstrument(Workspace=filename,Filename='/home/rwp/Mantid/mantidgeometry/CORELLI_Definition.xml')
