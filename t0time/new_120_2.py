...
LoadNexusMonitors(Filename='/SNS/CORELLI/IPTS-12310/nexus/CORELLI_14161.nxs.h5', OutputWorkspace='CORELLI_14161')
LoadNexusMonitors(Filename='/SNS/CORELLI/IPTS-12310/nexus/CORELLI_14278.nxs.h5', OutputWorkspace='CORELLI_14278')

MergeRuns(InputWorkspaces='CORELLI_14161,CORELLI_14278',OutputWorkspace='CORELLI_120')

# Smooth
Rebin(InputWorkspace='CORELLI_120', OutputWorkspace='CORELLI_120', Params='9.99,0.1,16666.59')
SmoothData(InputWorkspace='CORELLI_120', OutputWorkspace='CORELLI_120s',NPoints=100)
COR_120=mtd['CORELLI_120s']
m1,m2,m3=COR_120.extractY()
x1,x2,x3=COR_120.extractX()
