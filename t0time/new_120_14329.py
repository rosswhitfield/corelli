...
LoadNexusMonitors(Filename='/SNS/CORELLI/IPTS-12310/nexus/CORELLI_14329.nxs.h5', OutputWorkspace='CORELLI_120')
...
minima3_mask=np.ma.masked_where(d3ave[minima3]>-0.07,minima3)
maxima3_mask=np.ma.masked_where(d3ave[maxima3]<0.07,maxima3)
