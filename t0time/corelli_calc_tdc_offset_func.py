...
def calc_tdc_offset(filename='CORELLI_2257',bin_size=1):
 ...
 return filename+' Number of monitor events = '+str(len(tof))+' MotorSpeed = '+str(chopper_freq)+' Hz Chopper period = '+str(chopper_per)+' PhaseTimeDelaySet = '+str(delay)+"uS Chopper sequence offset = "+str(r2)+"ns"
